...
describe Salesforce::Structure do
  ...
  describe "replace_field_values_with_id" do
    ...
    it "should call lookup for school id" do
      Salesforce::Structure.should_receive(:get_first_record).with(:Id, :RecordType, "name='Mothers Support Group'").and_return("2")
      Salesforce::Structure.should_receive(:get_first_record).with(:Id, :School__c, "name='School A'").and_return("1")
  ...
  describe 'sync!' do
    it 'should should save!' do
      ...
      Salesforce::Structure.should_receive(:get_first_record).with(:Id, 'Structure__c', 'a=b')
